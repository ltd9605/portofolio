    ...
    <div className="home" id="home">
        <div className="home-container">
            <div className="home-content" >
                <span data-anim="zoom-in" data-anim-delay="0.2s" > <i class="fa-solid fa-graduation-cap"></i> IT student </span>
                <h1 data-anim="slide-left" data-anim-delay="0.1s"> Frontend<br /><h2 className='highlight-text'>Developer</h2></h1>
                ...
                <a href='#portofolio' data-anim="slide-right" data-anim-delay="0.1s" className='h-btn'>Project <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                <a href='#contact' data-anim="slide-right" data-anim-delay="0.1s" className='h-btn'>Contact <i class="fa-solid fa-envelope"></i></a>
